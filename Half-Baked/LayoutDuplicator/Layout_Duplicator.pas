...
function ComponentOnSheet(SchematicSheet: ISch_Sheet, RefDes: TPCB_String): Boolean;
Var
...
function GetSheetForComponent(RefDes: TPCB_String): Integer;
Var
    I           : Integer;
    Project     : IProject;
    Doc         : IDocument;
    ...
    Begin
        ...
        Begin
             ...
             Begin
                 ...
                 If ComponentOnSheet(CurrentSch, RefDes) Then
                 Begin
...
begin
    ...
    Begin
        ...
        Else
        Begin
            SchematicDoc := SchServer.GetSchDocumentBySchDocID(GetSheetForComponent(Unmatched.Get(0)));
        End;
...
function MatchDesignators(Board: IPCB_Board, Source: TStringList, Destination: TStringList) : Integer;
var
...
Begin
    ...
    Begin
        ShowMessage('Select source components before running script.');
        Exit;
    End;
    SheetSrc := GetSheetForComponent(SourceCmps.Get(0)); // Get the schematic sheet the source components are on
    ...
    Begin
        ...
        Exit;
    End;
    SheetDst := GetSheetForComponent(DestCmps.Get(0));
    ...
    MatchCount := MatchDesignators(Board, SourceCmps, DestCmps);
